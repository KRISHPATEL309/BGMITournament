...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.MatchViewAdapter> {
    ...
    public OrderAdapter(Context context, List<MatchData> list) {
...
//                intent.putExtra("MC",currentItem.getMatchTime());
...
//        });
        ...
        DatabaseReference reference;
        reference= FirebaseDatabase.getInstance().getReference().child("Matches").child(currentItem.getMatchTime()).child(currentItem.getReferencenum());
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                holder.room_id.setText("Room Id: "+roomID);
                holder.room_password.setText("Room Pass: "+roomPass);
            }
